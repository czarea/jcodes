package com.czarea.jcodes.plugin.ui;

import com.czarea.jcodes.Producer;
    ...
    private void onOK(Project project) {
        ...
        if (projectRadio.isSelected()) {
            ...
            try {
                ...
                Messages.showInfoMessage("成功生成代码! 耗时：" + (System.currentTimeMillis() - start) + "ms", "Success!");
                log.info("成功生成代码! 耗时：" + (System.currentTimeMillis() - start) + "ms");
            } catch (Exception e) {
                log.error("",e);
            }
        }
